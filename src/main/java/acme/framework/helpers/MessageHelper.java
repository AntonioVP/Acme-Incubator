...
public class MessageHelper {
	...
	// TODO: relocate this method somewhere closer to the 'framework.configuration'
	// package. Note that
	// TODO+ we need two different message sources: the global one, which is
	// appropriate for almost everything,
	// TODO+ and the validation one, which is appropriate for Validators only. The
	// only difference is that the
	// TODO+ global one can ignore codes that are not found in the i18n bundles,
	// whereas the validation one cannot.
